...
<div class="grid-content">
	<div class="main__content">
		...
		<form action="/module/tesla/admin/glazing/create" method="POST">
	...
	<?php foreach($essences as $essence): ?>
		...
		<a href="/module/tesla/admin/glazing/edit/<?php print $essence['id']; ?>">редактировать</a>

		<form action="/module/tesla/admin/glazing/delete" method="POST">
